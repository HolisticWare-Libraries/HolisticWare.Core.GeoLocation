...
{
    static string description = "Svetice Track Field 100m";
    static string description_colors = "// yella dots";
    static double lat1 = 45.81790486243052;
    static double lon1 = 16.01416600446859;
    static double lat2 = 45.81700539852965;
    static double lon2 = 16.014193032031084;
