...
[BenchmarkDotNet.Attributes.Orderer
                                (
                                    BenchmarkDotNet.Order.SummaryOrderPolicy.FastestToSlowest,
                                    BenchmarkDotNet.Order.MethodOrderPolicy.Declared
                                )
]
/*
[ThreadingDiagnoser]
...
{
    static string description = "Mladost Track Field 100m";
    static string description_colors = "";
    static double lat1 = 45.78312417366624;
    static double lon1 = 15.942453523323422;
    static double lat2 = 45.78222443736099;
    static double lon2 = 15.942481190386955;
