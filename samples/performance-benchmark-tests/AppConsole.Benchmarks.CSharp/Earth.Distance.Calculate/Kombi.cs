...
public partial class
                                            Kombi
{
    static string description = "// moljac's/mel's (zagreb) van 5.99 m";
    static string description_colors = "// red dots";
    static double lat1 = 45.7610525393467;
    static double lon1 = 16.00470531491805;
    static double lat2 = 45.761106805546284;
    static double lon2 = 16.004720067067375;
